...
urlpatterns = [
    ...
    path('studentlogin', LoginView.as_view(template_name='school/student/studentlogin.html')),


    path('afterlogin', views.afterlogin_view,name='afterlogin'),
    path('logout', LogoutView.as_view(template_name='school/others/index.html'),name='logout'),
    ...
    path('record_of_payment/', views.record_of_payment_view, name='record_of_payment'),
    path('history_of_day_payment/', views.history_of_day_payment_view, name='history_of_day_payment'),
    path('delete-payment/<int:pk>', views.deletepay_view,name='delete-payment'),
    path('delete-individual-pay/<str:pk>', views.delete_individual_pay_view,name='delete-individual-pay'),
    path('individual_student_info/<str:pk>/', views.individual_student_info_view, name='individual_student_info'),
